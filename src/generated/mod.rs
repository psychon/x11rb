...
pub enum Error<B: std::fmt::Debug + AsRef<[u8]>> {
    ...
    XprotoAccess(xproto::AccessError),
    XprotoAlloc(xproto::AllocError),
    XprotoAtom(xproto::AtomError),
    XprotoColormap(xproto::ColormapError),
    XprotoCursor(xproto::CursorError),
    XprotoDrawable(xproto::DrawableError),
    XprotoFont(xproto::FontError),
    XprotoGContext(xproto::GContextError),
    XprotoIDChoice(xproto::IDChoiceError),
    XprotoImplementation(xproto::ImplementationError),
    XprotoLength(xproto::LengthError),
    XprotoMatch(xproto::MatchError),
    XprotoName(xproto::NameError),
    XprotoPixmap(xproto::PixmapError),
    XprotoRequest(xproto::RequestError),
    XprotoValue(xproto::ValueError),
    XprotoWindow(xproto::WindowError),
    #[cfg(feature = "xv")]
...
impl<B: std::fmt::Debug + AsRef<[u8]>> Error<B> {
    ...
    pub fn parse(
        ...
        match error_code {
            xproto::ACCESS_ERROR => return Ok(Self::XprotoAccess(error.into())),
            xproto::ALLOC_ERROR => return Ok(Self::XprotoAlloc(error.into())),
            xproto::ATOM_ERROR => return Ok(Self::XprotoAtom(error.into())),
            xproto::COLORMAP_ERROR => return Ok(Self::XprotoColormap(error.into())),
            xproto::CURSOR_ERROR => return Ok(Self::XprotoCursor(error.into())),
            xproto::DRAWABLE_ERROR => return Ok(Self::XprotoDrawable(error.into())),
            xproto::FONT_ERROR => return Ok(Self::XprotoFont(error.into())),
            xproto::G_CONTEXT_ERROR => return Ok(Self::XprotoGContext(error.into())),
            xproto::ID_CHOICE_ERROR => return Ok(Self::XprotoIDChoice(error.into())),
            xproto::IMPLEMENTATION_ERROR => return Ok(Self::XprotoImplementation(error.into())),
            xproto::LENGTH_ERROR => return Ok(Self::XprotoLength(error.into())),
            xproto::MATCH_ERROR => return Ok(Self::XprotoMatch(error.into())),
            xproto::NAME_ERROR => return Ok(Self::XprotoName(error.into())),
            xproto::PIXMAP_ERROR => return Ok(Self::XprotoPixmap(error.into())),
            xproto::REQUEST_ERROR => return Ok(Self::XprotoRequest(error.into())),
            xproto::VALUE_ERROR => return Ok(Self::XprotoValue(error.into())),
            xproto::WINDOW_ERROR => return Ok(Self::XprotoWindow(error.into())),
            _ => {}
        }
...
pub enum Event<B: std::fmt::Debug + AsRef<[u8]>> {
    ...
    XprotoButtonPress(xproto::ButtonPressEvent),
    XprotoButtonRelease(xproto::ButtonReleaseEvent),
    XprotoCirculateNotify(xproto::CirculateNotifyEvent),
    XprotoCirculateRequest(xproto::CirculateRequestEvent),
    XprotoClientMessage(xproto::ClientMessageEvent),
    XprotoColormapNotify(xproto::ColormapNotifyEvent),
    XprotoConfigureNotify(xproto::ConfigureNotifyEvent),
    XprotoConfigureRequest(xproto::ConfigureRequestEvent),
    XprotoCreateNotify(xproto::CreateNotifyEvent),
    XprotoDestroyNotify(xproto::DestroyNotifyEvent),
    XprotoEnterNotify(xproto::EnterNotifyEvent),
    XprotoExpose(xproto::ExposeEvent),
    XprotoFocusIn(xproto::FocusInEvent),
    XprotoFocusOut(xproto::FocusOutEvent),
    XprotoGeGeneric(xproto::GeGenericEvent),
    XprotoGraphicsExposure(xproto::GraphicsExposureEvent),
    XprotoGravityNotify(xproto::GravityNotifyEvent),
    XprotoKeyPress(xproto::KeyPressEvent),
    XprotoKeyRelease(xproto::KeyReleaseEvent),
    XprotoKeymapNotify(xproto::KeymapNotifyEvent),
    XprotoLeaveNotify(xproto::LeaveNotifyEvent),
    XprotoMapNotify(xproto::MapNotifyEvent),
    XprotoMapRequest(xproto::MapRequestEvent),
    XprotoMappingNotify(xproto::MappingNotifyEvent),
    XprotoMotionNotify(xproto::MotionNotifyEvent),
    XprotoNoExposure(xproto::NoExposureEvent),
    XprotoPropertyNotify(xproto::PropertyNotifyEvent),
    XprotoReparentNotify(xproto::ReparentNotifyEvent),
    XprotoResizeRequest(xproto::ResizeRequestEvent),
    XprotoSelectionClear(xproto::SelectionClearEvent),
    XprotoSelectionNotify(xproto::SelectionNotifyEvent),
    XprotoSelectionRequest(xproto::SelectionRequestEvent),
    XprotoUnmapNotify(xproto::UnmapNotifyEvent),
    XprotoVisibilityNotify(xproto::VisibilityNotifyEvent),
    #[cfg(feature = "xv")]
...
impl<B: std::fmt::Debug + AsRef<[u8]>> Event<B> {
    ...
    pub fn parse(
        ...
        match event_type {
            ...
            xproto::BUTTON_PRESS_EVENT => return Ok(Self::XprotoButtonPress(event.into())),
            xproto::BUTTON_RELEASE_EVENT => return Ok(Self::XprotoButtonRelease(event.into())),
            xproto::CIRCULATE_NOTIFY_EVENT => return Ok(Self::XprotoCirculateNotify(event.into())),
            xproto::CIRCULATE_REQUEST_EVENT => return Ok(Self::XprotoCirculateRequest(event.into())),
            xproto::CLIENT_MESSAGE_EVENT => return Ok(Self::XprotoClientMessage(event.into())),
            xproto::COLORMAP_NOTIFY_EVENT => return Ok(Self::XprotoColormapNotify(event.into())),
            xproto::CONFIGURE_NOTIFY_EVENT => return Ok(Self::XprotoConfigureNotify(event.into())),
            xproto::CONFIGURE_REQUEST_EVENT => return Ok(Self::XprotoConfigureRequest(event.into())),
            xproto::CREATE_NOTIFY_EVENT => return Ok(Self::XprotoCreateNotify(event.into())),
            xproto::DESTROY_NOTIFY_EVENT => return Ok(Self::XprotoDestroyNotify(event.into())),
            xproto::ENTER_NOTIFY_EVENT => return Ok(Self::XprotoEnterNotify(event.into())),
            xproto::EXPOSE_EVENT => return Ok(Self::XprotoExpose(event.into())),
            xproto::FOCUS_IN_EVENT => return Ok(Self::XprotoFocusIn(event.into())),
            xproto::FOCUS_OUT_EVENT => return Ok(Self::XprotoFocusOut(event.into())),
            xproto::GRAPHICS_EXPOSURE_EVENT => return Ok(Self::XprotoGraphicsExposure(event.into())),
            xproto::GRAVITY_NOTIFY_EVENT => return Ok(Self::XprotoGravityNotify(event.into())),
            xproto::KEY_PRESS_EVENT => return Ok(Self::XprotoKeyPress(event.into())),
            xproto::KEY_RELEASE_EVENT => return Ok(Self::XprotoKeyRelease(event.into())),
            xproto::KEYMAP_NOTIFY_EVENT => return Ok(Self::XprotoKeymapNotify(event.into())),
            xproto::LEAVE_NOTIFY_EVENT => return Ok(Self::XprotoLeaveNotify(event.into())),
            xproto::MAP_NOTIFY_EVENT => return Ok(Self::XprotoMapNotify(event.into())),
            xproto::MAP_REQUEST_EVENT => return Ok(Self::XprotoMapRequest(event.into())),
            xproto::MAPPING_NOTIFY_EVENT => return Ok(Self::XprotoMappingNotify(event.into())),
            xproto::MOTION_NOTIFY_EVENT => return Ok(Self::XprotoMotionNotify(event.into())),
            xproto::NO_EXPOSURE_EVENT => return Ok(Self::XprotoNoExposure(event.into())),
            xproto::PROPERTY_NOTIFY_EVENT => return Ok(Self::XprotoPropertyNotify(event.into())),
            xproto::REPARENT_NOTIFY_EVENT => return Ok(Self::XprotoReparentNotify(event.into())),
            xproto::RESIZE_REQUEST_EVENT => return Ok(Self::XprotoResizeRequest(event.into())),
            xproto::SELECTION_CLEAR_EVENT => return Ok(Self::XprotoSelectionClear(event.into())),
            xproto::SELECTION_NOTIFY_EVENT => return Ok(Self::XprotoSelectionNotify(event.into())),
            xproto::SELECTION_REQUEST_EVENT => return Ok(Self::XprotoSelectionRequest(event.into())),
            xproto::UNMAP_NOTIFY_EVENT => return Ok(Self::XprotoUnmapNotify(event.into())),
            xproto::VISIBILITY_NOTIFY_EVENT => return Ok(Self::XprotoVisibilityNotify(event.into())),
