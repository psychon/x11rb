...
impl From<SaveSetMode> for Option<bool> {
    #[inline]
...
impl From<bool> for SaveSetMode {
    #[inline]
...
impl From<SaveSetTarget> for Option<bool> {
    #[inline]
...
impl From<bool> for SaveSetTarget {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
...
impl From<SaveSetMapping> for Option<bool> {
    #[inline]
...
impl From<bool> for SaveSetMapping {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
...
impl From<SelectionEvent> for Option<bool> {
    #[inline]
...
impl From<bool> for SelectionEvent {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
...
impl From<SelectionEventMask> for Option<bool> {
    #[inline]
...
impl From<bool> for SelectionEventMask {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
...
impl From<CursorNotify> for Option<bool> {
    #[inline]
...
impl From<bool> for CursorNotify {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
...
impl From<CursorNotifyMask> for Option<bool> {
    #[inline]
...
impl From<bool> for CursorNotifyMask {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
...
impl GetCursorImageRequest {
    ...
    pub fn send<Conn>(self, conn: &Conn) -> Result<Cookie<'_, Conn, GetCursorImageReply>, ConnectionError>
    where
        Conn: RequestConnection + ?Sized,
    {
        let (bytes, fds) = self.serialize(conn)?;
...
impl From<RegionEnum> for Option<bool> {
    #[inline]
...
impl FetchRegionRequest {
    ...
    pub fn send<Conn>(self, conn: &Conn) -> Result<Cookie<'_, Conn, FetchRegionReply>, ConnectionError>
    where
        Conn: RequestConnection + ?Sized,
    {
        let (bytes, fds) = self.serialize(conn)?;
...
impl GetCursorNameRequest {
    ...
    pub fn send<Conn>(self, conn: &Conn) -> Result<Cookie<'_, Conn, GetCursorNameReply>, ConnectionError>
    where
        Conn: RequestConnection + ?Sized,
    {
        let (bytes, fds) = self.serialize(conn)?;
...
impl GetCursorImageAndNameRequest {
    ...
    pub fn send<Conn>(self, conn: &Conn) -> Result<Cookie<'_, Conn, GetCursorImageAndNameReply>, ConnectionError>
    where
        Conn: RequestConnection + ?Sized,
    {
        let (bytes, fds) = self.serialize(conn)?;
...
impl From<BarrierDirections> for Option<bool> {
    #[inline]
...
impl From<bool> for BarrierDirections {
    #[inline]
    fn from(value: bool) -> Self {
        Self(value.into())
    }
