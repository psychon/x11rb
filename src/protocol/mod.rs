...
impl<B: std::fmt::Debug + AsRef<[u8]>> Error<B> {
    ...
    /// FIXME: Remove this
    pub(crate) fn map_unknown<N>(self, mapper: impl FnOnce(B) -> N) -> Error<N>
    where
        N: std::fmt::Debug + AsRef<[u8]>,
    {
        match self {
            Error::Unknown(buff) => Error::Unknown(mapper(buff)),
            Error::Access(e) => Error::Access(e),
            Error::Alloc(e) => Error::Alloc(e),
            Error::Atom(e) => Error::Atom(e),
            Error::Colormap(e) => Error::Colormap(e),
            Error::Cursor(e) => Error::Cursor(e),
            Error::Drawable(e) => Error::Drawable(e),
            Error::Font(e) => Error::Font(e),
            Error::GContext(e) => Error::GContext(e),
            Error::IDChoice(e) => Error::IDChoice(e),
            Error::Implementation(e) => Error::Implementation(e),
            Error::Length(e) => Error::Length(e),
            Error::Match(e) => Error::Match(e),
            Error::Name(e) => Error::Name(e),
            Error::Pixmap(e) => Error::Pixmap(e),
            Error::Request(e) => Error::Request(e),
            Error::Value(e) => Error::Value(e),
            Error::Window(e) => Error::Window(e),
            #[cfg(feature = "damage")]
            Error::DamageBadDamage(e) => Error::DamageBadDamage(e),
            #[cfg(feature = "glx")]
            Error::GlxBadContext(e) => Error::GlxBadContext(e),
            #[cfg(feature = "glx")]
            Error::GlxBadContextState(e) => Error::GlxBadContextState(e),
            #[cfg(feature = "glx")]
            Error::GlxBadContextTag(e) => Error::GlxBadContextTag(e),
            #[cfg(feature = "glx")]
            Error::GlxBadCurrentDrawable(e) => Error::GlxBadCurrentDrawable(e),
            #[cfg(feature = "glx")]
            Error::GlxBadCurrentWindow(e) => Error::GlxBadCurrentWindow(e),
            #[cfg(feature = "glx")]
            Error::GlxBadDrawable(e) => Error::GlxBadDrawable(e),
            #[cfg(feature = "glx")]
            Error::GlxBadFBConfig(e) => Error::GlxBadFBConfig(e),
            #[cfg(feature = "glx")]
            Error::GlxBadLargeRequest(e) => Error::GlxBadLargeRequest(e),
            #[cfg(feature = "glx")]
            Error::GlxBadPbuffer(e) => Error::GlxBadPbuffer(e),
            #[cfg(feature = "glx")]
            Error::GlxBadPixmap(e) => Error::GlxBadPixmap(e),
            #[cfg(feature = "glx")]
            Error::GlxBadRenderRequest(e) => Error::GlxBadRenderRequest(e),
            #[cfg(feature = "glx")]
            Error::GlxBadWindow(e) => Error::GlxBadWindow(e),
            #[cfg(feature = "glx")]
            Error::GlxGLXBadProfileARB(e) => Error::GlxGLXBadProfileARB(e),
            #[cfg(feature = "glx")]
            Error::GlxUnsupportedPrivateRequest(e) => Error::GlxUnsupportedPrivateRequest(e),
            #[cfg(feature = "randr")]
            Error::RandrBadCrtc(e) => Error::RandrBadCrtc(e),
            #[cfg(feature = "randr")]
            Error::RandrBadMode(e) => Error::RandrBadMode(e),
            #[cfg(feature = "randr")]
            Error::RandrBadOutput(e) => Error::RandrBadOutput(e),
            #[cfg(feature = "randr")]
            Error::RandrBadProvider(e) => Error::RandrBadProvider(e),
            #[cfg(feature = "record")]
            Error::RecordBadContext(e) => Error::RecordBadContext(e),
            #[cfg(feature = "render")]
            Error::RenderGlyph(e) => Error::RenderGlyph(e),
            #[cfg(feature = "render")]
            Error::RenderGlyphSet(e) => Error::RenderGlyphSet(e),
            #[cfg(feature = "render")]
            Error::RenderPictFormat(e) => Error::RenderPictFormat(e),
            #[cfg(feature = "render")]
            Error::RenderPictOp(e) => Error::RenderPictOp(e),
            #[cfg(feature = "render")]
            Error::RenderPicture(e) => Error::RenderPicture(e),
            #[cfg(feature = "shm")]
            Error::ShmBadSeg(e) => Error::ShmBadSeg(e),
            #[cfg(feature = "sync")]
            Error::SyncAlarm(e) => Error::SyncAlarm(e),
            #[cfg(feature = "sync")]
            Error::SyncCounter(e) => Error::SyncCounter(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeBadClock(e) => Error::Xf86vidmodeBadClock(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeBadHTimings(e) => Error::Xf86vidmodeBadHTimings(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeBadVTimings(e) => Error::Xf86vidmodeBadVTimings(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeClientNotLocal(e) => Error::Xf86vidmodeClientNotLocal(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeExtensionDisabled(e) => Error::Xf86vidmodeExtensionDisabled(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeModeUnsuitable(e) => Error::Xf86vidmodeModeUnsuitable(e),
            #[cfg(feature = "xf86vidmode")]
            Error::Xf86vidmodeZoomLocked(e) => Error::Xf86vidmodeZoomLocked(e),
            #[cfg(feature = "xfixes")]
            Error::XfixesBadRegion(e) => Error::XfixesBadRegion(e),
            #[cfg(feature = "xinput")]
            Error::XinputClass(e) => Error::XinputClass(e),
            #[cfg(feature = "xinput")]
            Error::XinputDevice(e) => Error::XinputDevice(e),
            #[cfg(feature = "xinput")]
            Error::XinputDeviceBusy(e) => Error::XinputDeviceBusy(e),
            #[cfg(feature = "xinput")]
            Error::XinputEvent(e) => Error::XinputEvent(e),
            #[cfg(feature = "xinput")]
            Error::XinputMode(e) => Error::XinputMode(e),
            #[cfg(feature = "xkb")]
            Error::XkbKeyboard(e) => Error::XkbKeyboard(e),
            #[cfg(feature = "xprint")]
            Error::XprintBadContext(e) => Error::XprintBadContext(e),
            #[cfg(feature = "xprint")]
            Error::XprintBadSequence(e) => Error::XprintBadSequence(e),
            #[cfg(feature = "xv")]
            Error::XvBadControl(e) => Error::XvBadControl(e),
            #[cfg(feature = "xv")]
            Error::XvBadEncoding(e) => Error::XvBadEncoding(e),
            #[cfg(feature = "xv")]
            Error::XvBadPort(e) => Error::XvBadPort(e),
        }
    }
}
